// Auth routes shared by the local backend/server.js and the Vercel
// serverless function in api/auth/[...slug].js — see api/_lib/db.js for why
// this is a copy rather than a cross-directory require().
...
async function ensureAdminFromEnv() {
  ...
  if (!ADMIN_USERNAME || !ADMIN_EMAIL || !ADMIN_PASSWORD) {
    console.warn('[Auth] ADMIN_USERNAME, ADMIN_EMAIL and ADMIN_PASSWORD must all be set to seed an admin account — skipping.');
    return;
  }
  ...
  console.log(`[Auth] Created admin account "${ADMIN_USERNAME}" from env.`);
}
...
module.exports = { router, requireAuth, requireAdmin, ensureAdminFromEnv };
